<script lang="ts">
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      logs = [...logs, 'Deployment successful!', `URL: ${data.url}`];
...
<div class="max-w-2xl mx-auto">
  <header class="mb-8">
    <a href="/" class="text-sm text-muted hover:underline">← Back to Dashboard</a>
  ...
  <div class="card">
    <form on:submit|preventDefault={handleSubmit} class="space-y-4">
      ...
      <div>
        ...
        />
        <p class="text-xs text-muted mt-1">Used for subdomain (app-name.localhost)</p>
      </div>
...
<style>
  ...
  .bg-slate-900 { background-color: #0f172a; border-color: #1e293b; }
